...
启动研究项目、查看阶段、跟踪 blocker 和 milestone，而不是把项目压缩成一段很长的聊天记录。

### Sources

把文献、政策文本、网页、社媒证据和数据集放进同一条 evidence-aware workflow。

### Analysis

从 notes、claims 和抽取结果，进入质性编码、量化分析、网络分析，以及与项目绑定的研究团队协作。

### Writing

统一处理提纲、草稿、写作质量检查、引文对齐、response pack 和投稿准备度。
...
- **Home**：工作台总览、当前项目、下一步建议
- **Projects**：项目列表、阶段流、blockers、milestones、新项目向导
- **Sources**：文献、数据、网页、社媒证据和集成状态
- **Analysis**：研究团队与方法工作区
- **Writing**：草稿、写作检查、投稿准备度
- **Settings**：本地配置、集成、validator 和高级项

## 集成方向

- **Zotero**：正式文献边界
- **Obsidian**：长期知识沉淀
- **Browser-visible evidence**：平台案例与网页证据
- **本地脚本与 validator**：透明而可复查的本地工作流

## 高级用户入口

如果你想看底层的 route、orchestrator、gate 和 validator，再从这里进入：
