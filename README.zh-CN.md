...
1. 先看 [快速开始](./docs/getting-started.md)，知道公开仓库怎么组织。
2. 再看 [操作指南](./docs/operator-guide.md)，理解项目跑起来后系统在做什么。
3. 最后看 [新项目上手](./docs/new-project-guide.md)，了解一个真实项目怎么开始。
...
- [新项目上手](./docs/new-project-guide.md)
