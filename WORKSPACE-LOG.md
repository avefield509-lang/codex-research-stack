...
- generated_at: 2026-04-24T15:15:18
- branch: `main`
- HEAD: `c5aa9c5`
...
- source label: release environment source repo
- source root: `C:\Users\17666\Desktop\AI environment-configuration\public-release\codex-research-stack`
- source branch at split: `main`
- source HEAD at split: `2d888cb`
- imported path set:
  - `README.md`
  - `README.zh-CN.md`
  - `LICENSE`
...
### Imported Uncommitted Source State
...
-  M docs/use-cases.md
-  M scripts/public_release_env.py
- ?? scripts/build-public-codex-console-bundle.ps1
- ?? scripts/build-public-codex-console.ps1
- ?? scripts/init_research_project.py
- ?? scripts/public_app_bridge.py
- ?? scripts/setup-public-codex-console.ps1
...
- A  docs/new-project-guide.html
- A  docs/operator-guide.html
- A  docs/use-cases.html
- M  docs/zh/getting-started.html
- M  docs/zh/integrations.html
- M  docs/zh/new-project-guide.html
- M  docs/zh/operator-guide.html
- M  docs/zh/use-cases.html
